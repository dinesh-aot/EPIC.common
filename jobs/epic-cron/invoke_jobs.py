    ...
    with application.app_context():
        if job_name == 'EXTRACT_PROJECT':
            ...
            if target_system == TargetSystem.SUBMIT and submit_schema_version == SUBMIT_SCHEMA_V2:
                ...
                application.logger.info('<<<< Completed Proponent Status Update >>>>')
            ...
            application.logger.info('Completed Email Task')
            ...
            application.logger.info('<<<< Completed EPIC Public Extraction >>>>')
...
if __name__ == "__main__":
    ...
    if job_type == "EMAIL":
        ...
        try:
            ...
            sys.exit(1)
        run("EXTRACT_WORK", submit_schema_version=submit_schema_version)
        ...
        run("EXTRACT_PROJECT", target_system, submit_schema_version=submit_schema_version)
